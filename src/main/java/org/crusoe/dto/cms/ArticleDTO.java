...
public class ArticleDTO {
	...
	private List<ChannelDTO> channelDTOs = new ArrayList<ChannelDTO>();
	...
	public void setArticleContentDTO(ArticleContentDTO aContentDTO) {
		this.articleContentDTO = aContentDTO;
	}
