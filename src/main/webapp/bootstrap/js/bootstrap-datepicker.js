...
!function($) {
	...
	var DatepickerB = function(element, options) {
	...
	DatepickerB.prototype = {
		constructor : DatepickerB,
	...
	$.fn.datepickerB = function(option, val) {
		return this
				.each(function() {
					var $this = $(this), data = $this.data('datepicker'), options = typeof option === 'object'
							&& option;
					if (!data) {
						$this.data('datepicker', (data = new DatepickerB(this,
								$
										.extend({}, $.fn.datepickerB.defaults,
												options))));
					}
	...
	$.fn.datepickerB.defaults = {
		onRender : function(date) {
			return '';
		}
	};
	$.fn.datepickerB.Constructor = DatepickerB;
